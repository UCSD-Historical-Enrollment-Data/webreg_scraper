...
Additionally, the following libraries are used extensively:
...
Note that the `misc` directory has some Python scripts; these are used to organize some files generated by this application. One prominent example is the course tracker. 
